...
### 🌡️ 발열 모니터링
* **CPU/GPU 온도 표시:** Apple Silicon IOHIDEventSystem을 통해 실시간 CPU/GPU 다이 온도를 각 행 오른쪽에 인라인 표시.
...
* **색상 경고 시스템:** 임계값 초과 시 수치를 색상으로 강조 표시.
  * CPU / GPU / Memory / Disk 사용량: 70% 이상 주황, 85% 이상 빨강.
  * CPU / GPU 온도: 70°C 이상 주황, 85°C 이상 빨강.
  * Battery (방전 중): 20% 이하 주황, 10% 이하 빨강 / 충전 중 80% 이상 초록.
